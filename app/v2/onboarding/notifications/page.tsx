...
export default function NotificationsPage() {
  ...
  return (
    <div className="v2-screen bg-chamber-900">
      <OnboardingHeader step={4} total={5} back="/v2/onboarding/topics" skip="/v2/onboarding/voice" />
      ...
      <div className="space-y-3">
        <Link href="/v2/onboarding/voice" className="v2-btn v2-btn-outline w-full">
          set up later
        </Link>
        <Link href="/v2/onboarding/voice" className="v2-btn v2-btn-light w-full">
          turn on motivation
        </Link>
      </div>
    </div>
