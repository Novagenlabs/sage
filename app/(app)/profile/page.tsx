    ...
    <div className="min-h-[100dvh] bg-chamber-900 pb-28 lg:pb-16">
      <div className="px-6 pt-[calc(env(safe-area-inset-top)+1.5rem)] lg:max-w-2xl lg:mx-auto lg:pt-12 lg:px-4">
        ...
        <Section title="account">
          <Row icon={<Lock className="h-4 w-4" />} label="passcode" href="/profile/passcode" />
          <Row icon={<Bell className="h-4 w-4" />} label="reminders" href="/onboarding/notifications" />
          <Row icon={<Moon className="h-4 w-4" />} label="ghost mode" href="/ghost" rightLabel={ghostOn ? "on" : "off"} />
        </Section>

        <Section title="plan">
          <Row icon={<CreditCard className="h-4 w-4" />} label="subscription" href="/credits" rightLabel={`${credits}`} />
          <Row icon={<Gift className="h-4 w-4" />} label="invite a friend" href="/referrals" rightLabel="earn 120" />
        </Section>

        <Section title="sage">
          <Row icon={<HelpCircle className="h-4 w-4" />} label="help" href="#" />
          <Row icon={<MessageSquare className="h-4 w-4" />} label="feedback" href="/profile/feedback" />
        </Section>
